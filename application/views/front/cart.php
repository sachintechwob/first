                      ...
                      <div class="shopping-cart">
                        ...
                        <?php if($cart){
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-5 my-auto">
                                    <div class="quantity">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="qty[]" value="<?php echo $item['qty']; ?>" readonly class="input-quantity qty<?php echo $i; ?>" />
                                ...
                                <div class="col-md-2 my-auto">
                                    <label class="price ">$<span class="updatePriceRow updatePrice<?php echo $i; ?>"><?php echo $item['price'] * $item['qty']; ?></span> </label>
                                </div>
                                <div class="col-md-2 col-5 my-auto">
                                    <div class="remove">
                                        <a href="<?php echo base_url('invite/removeCart/'. $item['id']); ?>" title='Remove' class="btn btn-danger btn-sm">
